...
def buildparser():
    ...
    subparsers_env = parser.add_subparsers(required=True, title="Development environments",
    ...
    parser_build.add_argument('--define',
    ...
    parser_build.add_argument('--rpmbuild-opts', action='append',
        help="Pass additional option(s) to rpmbuild")
    parser_build.add_argument('--rpmbuild-stage', action='store',
    ...
    parser_run = subparsers_container.add_parser('run',
    ...
    parser_shell = subparsers_container.add_parser('shell',
...
def container(args):
    ...
    if args.action == 'build':
        ...
        print(f'Unknown action: {args.action}, exiting')
        sys.exit(1)
